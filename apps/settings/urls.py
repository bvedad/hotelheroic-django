...
urlpatterns = [
    ...
    path('property-details/room-types/<int:pk>/edit/', views.settings_room_type_edit_view, name='settings_room_type_edit'),
    ...
    path('property-configuration/taxes-and-fees/', views.TaxesAndFeesListView.as_view(), name='settings_taxes_and_fees'),
    path('property-configuration/taxes-and-fees/<int:pk>/edit/', views.settings_taxes_and_fees_edit_view, name='settings_taxes_and_fees_edit'),
    path('property-configuration/taxes-and-fees/create/', views.settings_taxes_and_fees_create_view, name='settings_taxes_and_fees_create'),
    path('property-configuration/reservation-sources/', views.ReservationSourcesListView.as_view(), name='settings_reservation_sources'),
    path('property-configuration/reservation-sources/<int:pk>/edit/', views.settings_reservation_sources_edit_view, name='settings_reservation_sources_edit'),
    path('property-configuration/reservation-sources/create/', views.settings_reservation_sources_create_view, name='settings_reservation_sources_create'),
