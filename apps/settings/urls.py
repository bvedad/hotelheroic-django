...
urlpatterns = [
    ...
    path('property-configuration/invoicing/invoice-details/', views.settings_property_configuration_invoice_details_edit_view,
         name='settings_property_configuration_invoice_details_edit'),
    path('property-configuration/invoicing/invoicing-settings/', views.settings_property_configuration_invoicing_settings_edit_view,
