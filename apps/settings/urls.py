...
urlpatterns = [
    ...
    path('property-configuration/guest-statuses/', views.GuestStatusListView.as_view(), name='settings_guest_status_index'),
    path('property-configuration/guest-statuses/<int:pk>/edit/', views.settings_guest_status_edit_view, name='settings_guest_status_edit'),
    path('property-configuration/guest-statuses/create/', views.settings_guest_status_create_view, name='settings_guest_status_create'),
    path('property-details/property-amenities/', views.HotelAmenityListView.as_view(), name='settings_hotel_amenity_index'),
    path('property-details/property-amenities/<int:pk>/edit/', views.settings_hotel_amenity_edit_view, name='settings_hotel_amenity_edit'),
    path('property-details/property-amenities/create/', views.settings_hotel_amenity_create_view, name='settings_hotel_amenity_create'),
