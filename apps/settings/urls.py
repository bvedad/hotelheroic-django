...
urlpatterns = [
    ...
    path('custom-payment-method/create/', views.CustomPaymentMethodCreateView.as_view(), name='create_custom_payment_method'),
    path('custom-payment-method/update/<int:pk>/', views.CustomPaymentMethodUpdateView.as_view(), name='update_custom_payment_method'),
    path('custom-payment-method/delete/<int:pk>/', views.CustomPaymentMethodDeleteView.as_view(), name='delete_custom_payment_method'),
