...
urlpatterns = [
    ...
    path('property-configuration/item-categories/', views.ItemCategoryListView.as_view(), name='settings_item_category_index'),
    path('property-configuration/item-categories/<int:pk>/edit/', views.settings_item_category_edit_view, name='settings_item_category_edit'),
    path('property-configuration/item-categories/create/', views.settings_item_category_create_view, name='settings_item_category_create'),
